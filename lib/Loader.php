...
class Loader {
    ...
    public function loadClass()
    {
        function __autoload($classname) {
            $controller_cls = BASE_PATH . DS . "controllers" . DS . $classname . ".php"; //echo $controller_cls;
            $model_cls = BASE_PATH . DS . "models" . DS . $classname . ".php";
            //$router_cls = BASE_PATH . DS . "router.php";
            ...
            if (file_exists($controller_cls)) {
                ...
                throw new Exception("Error loading files ".$classname);
            }
        }
